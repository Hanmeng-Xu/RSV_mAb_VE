...
### Figure `r fig.counter`. Sex & Age at testing (after removing age at testing > 1 yo records )
```{r}
fig.counter <- fig.counter + 1
...
#### Recode these two to sample_source variable (might not be very useful?):
...
Each record can have multiple risk factors.
```{r}
tab.counter <- tab.counter + 1
