...
```{r}
df %>%
  mutate(race = case_when(Race %in% c("White") ~ "White",
                          Race %in% c("I Do Not See My Race Listed Here") ~ "unknown"))
...
#### Combine race and ethnicity into one variable: generate this new variable called "race_ethnicity" (pending, TBC)
```{r}
df <- df %>% 
