...
footnote_atleastoneriskfactor <- "Have at least one of the following conditions recorded in the infant's medical history or diagnosis records: 1) Anemia; 2) Asthma; 3) Liver diseases; 4) Immunodeficiency (e.g. transplantation history, leukemia, etc.); 5) Cardiac diseases (including congenital heart diseases diagnosed at birth or any reporting of heart conditions); 6) Pulmonary diseases; 7) Down syndrome; 8) Exposed to environmental exposures during gestation period or at young age (including chemical exposures: tobacco exposure, secondhand smoke etc., and socioeconomic factors: financial difficulties, unemployed parents, homelessness, etc.); 9) Small for gestational age (birth weight < 2,500 grams); 10) Prematurity (gestational age less than 37 weeks)."
